...
public class ClientCarefulBreakState {
	...
	public static void apply(boolean enabled, boolean carefulBreak, boolean carefulDrop,
			...
			boolean autoReplantTrees, boolean autoReplantCrops) {
		...
		ClientCarefulBreakState.autoReplantTrees = autoReplantTrees;
		ClientCarefulBreakState.autoReplantCrops = autoReplantCrops;
	}
}
